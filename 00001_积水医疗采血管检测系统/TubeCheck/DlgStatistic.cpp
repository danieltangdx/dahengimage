...
BOOL CDlgStatistic::OnInitDialog() 
{
	...
	m_listData.InsertColumn(0, "开检时间", LVCFMT_LEFT,iWidth*2);	
	m_listData.InsertColumn(1, "停检时间", LVCFMT_LEFT,iWidth*2);
	m_listData.InsertColumn(2, "模板名称", LVCFMT_LEFT,(int)(iWidth*1.5));	
	m_listData.InsertColumn(3, "检测总数", LVCFMT_LEFT,(int)(iWidth*1.5));
	m_listData.InsertColumn(4, "合格品数", LVCFMT_LEFT,(int)(iWidth*1.5));
	m_listData.InsertColumn(5, "不合格数", LVCFMT_LEFT,(int)(iWidth*1.5));
	m_listData.InsertColumn(6, "不合格率", LVCFMT_LEFT,(int)(iWidth*1.5));
