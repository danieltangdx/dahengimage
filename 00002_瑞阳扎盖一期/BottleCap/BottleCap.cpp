// BottleCap.cpp : Defines the class behaviors for the application.
//
...
CBottleCapDoc*	    g_pDoc  = NULL;
CBottleCapView*	    g_pView = NULL;
...
BEGIN_MESSAGE_MAP(CBottleCapApp, CWinApp)
	//{{AFX_MSG_MAP(CBottleCapApp)
...
/////////////////////////////////////////////////////////////////////////////
// CBottleCapApp construction

CBottleCapApp::CBottleCapApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CBottleCapApp object

CBottleCapApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CBottleCapApp initialization

BOOL CBottleCapApp::InitInstance()
{
	...
	//保证程序运行唯一
	HANDLE hMapping = ::CreateFileMapping((HANDLE)0xFFFFFFFF, NULL, PAGE_READWRITE, 0, 16, "BottleCap");
	if (hMapping == NULL)
	{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CBottleCapDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CBottleCapView));
	...
	//获取全局类指针
	g_pDoc  = (CBottleCapDoc*)g_pFrame->GetActiveDocument();
	g_pView = (CBottleCapView*)g_pFrame->GetActiveView();
...
BOOL CBottleCapApp::RockeyIsExist()
{
...
BOOL CBottleCapApp::RockeyIsExist_HD()
{
...
//获取本执行程序所在的路径
CString CBottleCapApp::GetCurrentAppPath()
{
...
/////////////////////////////////////////////////////////////////////////////
// CBottleCapApp message handlers


int CBottleCapApp::ExitInstance() 
{
