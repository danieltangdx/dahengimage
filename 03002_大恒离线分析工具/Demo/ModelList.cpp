...
BEGIN_MESSAGE_MAP(CModelList, CListBox)
...
void CModelList::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
void CModelList::MeasureItem(LPMEASUREITEMSTRUCT lpMeasureItemStruct) 
{
	// TODO: Add your code to determine the size of specified item
	lpMeasureItemStruct->itemHeight = 16;
}

int CModelList::AddString(LPCTSTR lpszItem)
{
...
int CModelList::AddString(LPCTSTR lpszItem, int iImg)
{
	int iRet = CListBox::AddString(lpszItem);
	if (iRet >= 0)
...
int CModelList::InsertString(int iIndex, LPCTSTR lpszItem)
{
...
int CModelList::InsertString(int iIndex, LPCTSTR lpszItem, int iImg)
{
	int iRet = CListBox::InsertString(iIndex,lpszItem);
	if (iRet >= 0)
		SetItemData(iRet, iImg);
...
void CModelList::SetItemImage(int iIndex, int iImg)
{
