...
namespace General 
{
	...
	public:
		...
		int* p_iChannel;//**[1/17/2018 ConanSteve]**:  图像数据的通道数,黑白图为1，彩色图为3
	...
	enum e_DrawImgType//**[11/21/2017 ConanSteve]**:   0都不显示，1只显示系统图像，2只显示算法检测图像,3两者都显示
	{
		e_DrawImgType_NONE,//**[11/21/2017 ConanSteve]**:  都不显示
		e_DrawImgType_Sys,//**[11/21/2017 ConanSteve]**:  只显示系统图像
		e_DrawImgType_Alg,//**[11/21/2017 ConanSteve]**:  只显示算法检测图像
		e_DrawImgType_Both//**[11/21/2017 ConanSteve]**:  两者都显示
	};
	...
	public:
		...
		e_DrawImgType		iDrawImgType;	//*[7/3/2017 ConanSteve]*:  0都不显示，1只显示系统图像，2只显示算法检测图像,3两者都显示
		int		iSaveImageMode;	//**[10/10/2017 ConanSteve]**:  存图模式： 0不存图 其他值，根据ParamGrid配置文件来配置
		/*************************************<下面6个参数与Init里面传递的一样>************************************[1/24/2018 ConanSteve]*/
		//**[1/24/2018 ConanSteve]**:  主要是为了兼容没有模板图像的算法在Demo下无法从Init得到这些数据
		int* p_iCount;//**[10/10/2017 ConanSteve]**:  每个窗口多少张图
		int* p_iWidth;//**[8/30/2017 ConanSteve]**:  图像宽度
		int* p_iHeight;//**[8/30/2017 ConanSteve]**:  图像高度
		int* p_iBayer;//**[8/30/2017 ConanSteve]**:  贝尔变换类型
	...
	public:
		...
		bool bStopMachine[64];//**[1/9/2018 ConanSteve]**:  检测停机
		bool bAlarm[64];//**[1/9/2018 ConanSteve]**:  报警
		TCHAR lpszCheckDesc[MAX_PATH];//**[1/17/2018 ConanSteve]**:  检测描述信息
