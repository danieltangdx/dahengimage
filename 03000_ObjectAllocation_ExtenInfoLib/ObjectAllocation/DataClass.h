...
protected:
	...
	/*****************************************************************************************************************************************************************************************/
	unique_ptr<unique_ptr<CAlgCopyWindow[]>[]> m_arr_ppAlgCpoyWindowPara;
	unique_ptr<unique_ptr<CAlgCopyWindow[]>[]> m_ppCopyWindowParaCacheQueue;//**[10/9/2017 ConanSteve]**:  图像缓存队列对应的信息
	unique_ptr<unique_ptr<CAlgCopyWindow[]>[]> m_ppCopyWindowParaAlgObjQueue;//**[10/9/2017 ConanSteve]**:  算法检测对象队列对应的信息
