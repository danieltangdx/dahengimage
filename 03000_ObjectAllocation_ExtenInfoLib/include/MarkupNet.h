...
public:
	...
	// Navigate
	bool Load( MCD_CSTR_FILENAME szFileName );//**[9/14/2017 ConanSteve]**:  导入一个XML文件到CMarkup的对象中，并对它进行解析。类似C#的Load。
	bool SetDoc( MCD_PCSZ pDoc );//**[9/14/2017 ConanSteve]**:  从字符串中导入XML数据，并对它解析。类似C#的LoadXml。
	...
	// Create
	bool Save( MCD_CSTR_FILENAME szFileName );//**[9/14/2017 ConanSteve]**:  将XML数据写入文件中。类似C#的Save。
