...
*    Notes:
*    Created:		17.04.2007
*    Last modified:	$Date: 2011-08-02 10:32:17 +0200 (Di, 02 Aug 2011) $
*                         
*                         
...
#ifndef _BGAPIDEF_HPP__
#define _BGAPIDEF_HPP__
...
enum BGAPI_FeatureId
{
	...
	*/
	...
	/**
	\brief Select digital outputs into sequencer parameter sets.
	*/
	BGAPI_FEATUREID_CAMERA_BOSEQUENCERIOSELECTOR = 534,

	/**
	\brief Status for selected digital output of sequencer parameter sets.
	*/
	BGAPI_FEATUREID_CAMERA_BOSEQUENCERIOSTATUS = 535,
...
enum BGAPI_Type
{
	...
	*/	
	...
	/**
	\brief The value is boolean value.
	*/	
    BGAPI_TYPE_BOOL = 1,
...
*/
enum BGAPI_GigeTriggerDeviceMode
{
	/**
...
*/
enum BGAPI_SensorDigitizationTaps
{
	/**
...
*/
enum BGAPI_ToFModulationFrequency
{
 	/**
	\brief 14.5 Mhz.
	*/
...
/** 
\brief The BGAPIX_TypeBOOL holds information of a simple "bool" feature.
*/
typedef struct {  
	/**
...
/** 
\brief The BGAPIX_TypeArrayBOOL holds information of an "bool array" feature.
\brief The size of array is fix and limited to 32 entrys.
\brief An indicator of used values is represented by 'length' 
\brief The reason of a static size is the portability of structures and functions to 
\brief other programming languages
...
/** 
\brief The BGAPIX_TypeLargeArrayBOOL holds information of an "bool array " feature.
\brief The size of array is fix and limited to 4096 entrys.
\brief An indicator of used values is represented by 'length' 
\brief The reason of a static size is the portability of structures and functions to 
\brief other programming languages
...
typedef struct
{
	...
	struct GIGERESEND
	{
        ...
        unsigned int FirstResendWaitPacketsDualLink;	//the number of packets to wait before sending a resend request
        unsigned int NextResendWaitPacketsDualLink;		//the number of packets to wait before resendening a resend request
...
enum BGAPI_LineOutputSource
{
	...
	*/
	...
	/**
	\brief Exposure Enlarged.
	*/
	BGAPI_LINEOUTPUTSOURCE_EXPOSUREENLARGED = 210,
	/**
...
enum BGAPI_MessageId
{
	...
	*/
	...
	/**
	\brief Primary Application Switch
	*/
	BGAPI_MESSAGEID_PRIMARYAPPLICATIONSWITCH = 96,

	/**
	\brief Event Discarded
	*/
	BGAPI_MESSAGEID_EVENTDISCARDED = 97,
