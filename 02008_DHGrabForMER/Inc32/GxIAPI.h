...
typedef enum GX_PIXEL_FORMAT_ENTRY
{
	...
	GX_PIXEL_FORMAT_RGB10V1_PACKED     = (GX_PIXEL_COLOR | GX_PIXEL_32BIT | 0x001C),//0x220001C,
	GX_PIXEL_FORMAT_RGB10V2_PACKED     = (GX_PIXEL_COLOR | GX_PIXEL_32BIT | 0x001D),//0x220001D,
...
typedef struct GX_DEVICE_IP_INFO 
{
	...
	char szMAC[GX_INFO_LENGTH_32_BYTE];                  ///< MAC地址
	char szIP[GX_INFO_LENGTH_32_BYTE];                   ///< IP地址
	char szSubNetMask[GX_INFO_LENGTH_32_BYTE];           ///< 子网掩码
	char szGateWay[GX_INFO_LENGTH_32_BYTE];              ///< 网关
	char szNICMAC[GX_INFO_LENGTH_32_BYTE];               ///< 对应网卡的MAC地址
	char szNICIP[GX_INFO_LENGTH_32_BYTE];                ///< 对应网卡的IP地址
	char szNICSubNetMask[GX_INFO_LENGTH_32_BYTE];        ///< 对应网卡的子网掩码
	char szNICGateWay[GX_INFO_LENGTH_32_BYTE];           ///< 对应网卡的网关
	char szNICDescription[GX_INFO_LENGTH_128_BYTE + 4];  ///< 对应网卡描述
...
*/
//----------------------------------------------------------------------------------
GX_API GXImportConfigFile(GX_DEV_HANDLE hDevice, const char * pszFilePath, bool bVerify = true);
